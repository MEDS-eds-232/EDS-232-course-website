...
- The exam will have two (slightly longer) scenarios, in which you are requested to interpret results and discuss statements. 
...
**Q5.** Is this statement true or false? Explain your reasoning.

**Q6.** Interpret the slope coefficient $\hat{\beta}_1 = -3.1$ in the context of this study.

**Q7.** Use the $p$-value to draw a conclusion about whether SST is a statistically significant predictor of survival rate.

**Q8.** A monitoring site has SST = 16 °C. Use the fitted model to predict the survival rate at that site.

**Q9.** Another team member suggests:
...
**Q1.**  Which metric should the team prioritize recall or precision? Use High Carbon as the positive class and explain why.
...
**Q3.** Explain to the team what a false positive is in the context of this problem and identify one from the test points in the plot.
...
**BONUS** Describe the steps of k-fold cross-validation. What does the final CV score estimate?