...
ax.set_xlabel('Temp. anomaly (°C)')
ax.set_ylabel('Nitrate (μmol/L)')
ax.set_title('Selecting a threshold creates a decision boundary for the fitted logistic model')
ax.grid(True, alpha=0.3)
fig.colorbar(cf, ax=ax, label='P(healthy)', shrink=0.8)
plt.tight_layout()
plt.show()
...
ax.set_xlabel('Temp. anomaly (°C)')
ax.set_ylabel('Nitrate (μmol/L)')
ax.set_title('Apply classifier to test data (90 pts)')
...
Points in the "wrong" region are misclassified test observations.
:::
