...
Test error is usually the measure of interest for evaluating real-world performance, just as we saw in regression.
...
- **Large $K$**: the boundary becomes very smooth, determined by a large neighborhood. Very rigid.
