...
ax.legend(title='True status', fontsize=12)
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.show()
plt.close()
...
1. Predict the class for every point in our test set and compare it against its true class
...
**Precision**: *of all the predicted positives, how many are truly positive?*
$$\text{precision} = \frac{TP}{TP + FP}$$

**Recall** (sensitivity): *of all observations whose true class is positive, how many did we correctly identify?*
...
## {#checkin-metrics-table-1 data-menu-title="Check-in: metrics table"}
...
## {#checkin-metrics-table-2 data-menu-title="Check-in: metrics table"}
...
## {#error-rate-blank data-menu-title="Classification error rate"}
