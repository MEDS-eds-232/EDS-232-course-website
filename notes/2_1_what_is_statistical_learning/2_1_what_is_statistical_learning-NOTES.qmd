...
[📊 Slides](2_1_what_is_statistical_learning-SLIDES.qmd) / [📊 Blank slides](2_1_what_is_statistical_learning-SLIDES-BLANK.qmd)
...
2. Do **predictions**: this means calculating $\hat{f}(X) = \hat{Y}$ to predict what the value of $Y$ will be with at a new input $X$. 
