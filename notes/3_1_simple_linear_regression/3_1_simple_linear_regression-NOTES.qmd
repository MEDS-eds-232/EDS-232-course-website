...
- *RSE is measured in the same units as $Y$*, which makes it interpretable but also context dependent. What a small RSE is depends on what we are measuring: an RSE of 50 seals might be great for a population of 500, but poor for a population of 60.
:::
