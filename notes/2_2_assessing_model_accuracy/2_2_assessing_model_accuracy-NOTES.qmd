...
Data was simulated based on the function $f$ shown in black in the plot. The data is spllit into train data (black circles) and test data (red circles). 
...
- Going back to the classification setting: recap of the notation 
- Instead of MSE, the most common way of assessing error is the **error rate**
- Error rate formula (verbal, simplify)
- KNN method explanation. Figure 2.14
