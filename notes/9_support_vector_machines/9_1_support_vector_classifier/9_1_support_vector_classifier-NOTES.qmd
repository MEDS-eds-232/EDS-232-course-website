...
[📊 Slides](9_1_support_vector_classifier-SLIDES.qmd) 
...
# Small ISLP budget C  → few violations → narrow margin  (high sklearn C)
# Large ISLP budget C  → many violations  → wide margin  (small sklearn C)
...
:::{.callout-tip}
## Check-in
1. Explain why a small margin corresponds to higher bias and lower viarance, and why a large margin corresponds to lower bias and higher variance. 
