...
svc_narrow = SVC(kernel='linear', C=1000)  # narrow margin
...
fig, axes = plt.subplots(2, 1, figsize=(fig_size_x * 0.9, (fig_size_y + 1.5) * 2),
                          sharex=True)
...
:::{.callout-tip}
## Check-in
1. Explain why a small margin corresponds to higher bias and lower viarance, and why a large margin corresponds to higher bias and lower variance. 
