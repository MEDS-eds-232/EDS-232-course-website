...
The support vector classifier finds the best **linear** boundary — but what if no straight line can adequately separate the classes?
...
::: {.body-text-m}
- The SVC still fits a **linear** hyperplane — but now in the *enlarged* space
- This produces a **non-linear** boundary in the *original* space
