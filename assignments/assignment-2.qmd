...
This assignment covers topics from the course on classification, specifically KNN and Logistic Regression. Task 1 will contribute 30% to the total grade and Task 2 will contribute 70%. Review the rubric for this assignment [here](https://docs.google.com/document/d/1a5_Eu_RZ24BMorTcvYepYpxLLjZdb79rRsCvU7LMaFQ/edit?tab=t.0#heading=h.kx0dpavp3fk4). 
...
Your submission should be a Jupyter notebook with the following structure:
...
- Compare KNN and Logistic Regression model performance
- Evaluate a classifier with an ROC Curve and AUC score
